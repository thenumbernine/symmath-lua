...
build = {
	...
	modules = {
		...
		["symmath.PartialDerivative"] = "PartialDerivative.lua",
		["symmath.Sum"] = "Sum.lua",
		...
		["symmath.server.detect"] = "server/detect.lua",
		["symmath.server.index.html"] = "server/index.html.lua",
		["symmath.server.server"] = "server/server.lua",
		...
		["symmath.tests.latex_spherical_metric"] = "tests/latex_spherical_metric.lua",
