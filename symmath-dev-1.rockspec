...
build = {
	...
	modules = {
		...
		["symmath.js.make_lua-packages"] = "js/make_lua-packages.lua",
		["symmath.log"] = "log.lua",
		...
		["symmath.matrix.hermitian"] = "matrix/hermitian.lua",
		...
		["symmath.physics.MatrixBasis"] = "physics/MatrixBasis.lua",
		...
		["symmath.tests.Finite Difference Coefficients"] = "tests/Finite Difference Coefficients.lua",
		...
		["symmath.tests.Lorentz group"] = "tests/Lorentz group.lua",
		...
		["symmath.tests.Platonic Solids - cache"] = "tests/Platonic Solids - cache.lua",
		...
		["symmath.tests.Z4 - flux PDE noSource"] = "tests/Z4 - flux PDE noSource.lua",
		["symmath.tests.Z4 - flux PDE noSource usingOnlyUs"] = "tests/Z4 - flux PDE noSource usingOnlyUs.lua",
		["symmath.tests.black hole brain"] = "tests/black hole brain.lua",
		["symmath.tests.console_spherical_metric"] = "tests/console_spherical_metric.lua",
		["symmath.tests.elastic plate"] = "tests/elastic plate.lua",
		...
		["symmath.tests.imperial units"] = "tests/imperial units.lua",
		...
		["symmath.tests.solve cubic"] = "tests/solve cubic.lua",
		...
		["symmath.tests.unit-cache.tests_unit_Matrix eigen"] = "tests/unit-cache/tests_unit_Matrix eigen.lua",
		["symmath.tests.unit-cache.tests_unit_Variable dependsOn"] = "tests/unit-cache/tests_unit_Variable dependsOn.lua",
		["symmath.tests.unit-cache.tests_unit_func"] = "tests/unit-cache/tests_unit_func.lua",
		["symmath.tests.unit-cache.tests_unit_getIndexesUsed"] = "tests/unit-cache/tests_unit_getIndexesUsed.lua",
		["symmath.tests.unit-cache.tests_unit_index_construction"] = "tests/unit-cache/tests_unit_index_construction.lua",
		["symmath.tests.unit-cache.tests_unit_integral"] = "tests/unit-cache/tests_unit_integral.lua",
		["symmath.tests.unit-cache.tests_unit_limit"] = "tests/unit-cache/tests_unit_limit.lua",
		["symmath.tests.unit-cache.tests_unit_match"] = "tests/unit-cache/tests_unit_match.lua",
		["symmath.tests.unit-cache.tests_unit_matrix"] = "tests/unit-cache/tests_unit_matrix.lua",
		["symmath.tests.unit-cache.tests_unit_notfinite"] = "tests/unit-cache/tests_unit_notfinite.lua",
		["symmath.tests.unit-cache.tests_unit_polyCoeffs"] = "tests/unit-cache/tests_unit_polyCoeffs.lua",
		["symmath.tests.unit-cache.tests_unit_polydiv"] = "tests/unit-cache/tests_unit_polydiv.lua",
		["symmath.tests.unit-cache.tests_unit_replace"] = "tests/unit-cache/tests_unit_replace.lua",
		["symmath.tests.unit-cache.tests_unit_replaceIndex"] = "tests/unit-cache/tests_unit_replaceIndex.lua",
		["symmath.tests.unit-cache.tests_unit_sets"] = "tests/unit-cache/tests_unit_sets.lua",
		["symmath.tests.unit-cache.tests_unit_simplifyMetrics"] = "tests/unit-cache/tests_unit_simplifyMetrics.lua",
		["symmath.tests.unit-cache.tests_unit_solve"] = "tests/unit-cache/tests_unit_solve.lua",
		["symmath.tests.unit-cache.tests_unit_sqrt"] = "tests/unit-cache/tests_unit_sqrt.lua",
		["symmath.tests.unit-cache.tests_unit_symmetrizeIndexes"] = "tests/unit-cache/tests_unit_symmetrizeIndexes.lua",
		["symmath.tests.unit-cache.tests_unit_tensor sub-assignment"] = "tests/unit-cache/tests_unit_tensor sub-assignment.lua",
		["symmath.tests.unit-cache.tests_unit_tensor sub-index"] = "tests/unit-cache/tests_unit_tensor sub-index.lua",
		["symmath.tests.unit-cache.tests_unit_test"] = "tests/unit-cache/tests_unit_test.lua",
		["symmath.tests.unit-cache.tests_unit_tidyIndexes"] = "tests/unit-cache/tests_unit_tidyIndexes.lua",
		["symmath.tests.unit.Matrix eigen"] = "tests/unit/Matrix eigen.lua",
