...
description = {
	summary = 'computer algebra system for Lua',
	detailed = 'computer algebra system for Lua',
...
build = {
	...
	modules = {
		...
		['symmath.tests.Maxwell'] = 'tests/Maxwell.lua',
		...
		['symmath.tests.exp_metric'] = 'tests/exp_metric.lua',
		...
		['symmath.tests.unit.simplify loop'] = 'tests/unit/simplify loop.lua',
		...
		['symmath.tests.wave equation with metric of space and time - based on bssnok-scalar'] = 'tests/wave equation with metric of space and time - based on bssnok-scalar.lua',
