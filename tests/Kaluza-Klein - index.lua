...
printbr[[$E = \frac{1}{2} \lambda k_e \frac{1}{r} = \frac{1}{2} \pi R^2 \rho_{charge} e k_e \frac{1}{r} =$ {=={electric_field_in_kg_m2_per_C_s2 = charge_per_unit_length_in_C_per_m * .5 * Coulomb_constant_in_kg_m3_per_C2_s2 / field_measure_distance_in_m}==} $\cdot \frac{kg \cdot m}{C \cdot s^2}$ = electric field magnitude.]]
