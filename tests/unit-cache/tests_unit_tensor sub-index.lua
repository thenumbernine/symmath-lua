{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="reading by __index doesn't work?", duration=9.9999999999406e-07},
	{code="", comment="I guess only writing by __index does for now", duration=9.9999999999406e-07},
	...
	{code="", comment="printbr(T['_ij'])\9\9assertEq(T['_ij'], T)", duration=1.9999999999951e-06},
	...
	{code="", comment="printbr(T['_yx'])\9\9assertEq(T['_yx'], T[2][1])", duration=9.9999999999406e-07},
	{code="", comment="printbr(T['_yy'])\9\9assertEq(T['_yy'], T[2][2])", duration=9.9999999999406e-07},
