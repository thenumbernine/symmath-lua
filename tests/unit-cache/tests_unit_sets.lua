{
	...
	{code="", comment="subsets", duration=9.9999999999753e-07},
	...
	{code="", comment="../../asinh.lua:asinh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=7.0000000000001e-06},
	{code="", comment="../../atan.lua:atan.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=0},
	{code="", comment="../../cosh.lua:cosh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_evenIncreasing", duration=0},
	{code="", comment="../../acos.lua:function acos:getRealRange()", duration=0},
	{code="", comment="../../acos.lua:\9local Is = self[1]:getRealRange()", duration=1.000000000001e-06},
	...
	{code="", comment="../../log.lua:log.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_posInc_negIm", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/add.lua:\9local I = self[1]:getRealRange()", duration=0},
	{code="", comment="../../op/add.lua:\9\9local I2 = self[i]:getRealRange()", duration=0},
