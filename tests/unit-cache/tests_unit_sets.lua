{
	{code="", comment="TODO do unit tests with the RealInterval / RealSubset operators", duration=1.000000000001e-06},
	...
	{code="", comment="instead here use isSubsetOf", duration=9.9999999999753e-07},
	{code="", comment="", duration=0},
	{
		code="assert(set.real:isSubsetOf(set.real) == true)",
		comment="",
		duration=2.7000000000003e-05,
		simplifyStack={}
	},
	{
	...
	{code="", comment="", duration=1.8000000000001e-05},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=0},
	{code="", comment="realinterval", duration=9.9999999999753e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="maybe.", duration=1.000000000001e-06},
	{code="", comment="not certainly yes (subset).", duration=1.000000000001e-06},
	{code="", comment="not certainly no (complement intersection / set subtraction is empty).", duration=9.9999999999406e-07},
	...
	{code="", comment="if x's set does not intersect this set then return false", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="x^2 should be positive", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="../../sin.lua:function sin:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../cosh.lua:cosh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_evenIncreasing", duration=9.9999999999406e-07},
	{code="", comment="../../acos.lua:function acos:getRealRange()", duration=3.000000000003e-06},
	...
	{code="", comment="../../sqrt.lua:sqrt.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_posInc_negIm", duration=0},
	...
	{code="", comment="../../acosh.lua:function acosh:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../cos.lua:\9\9-- here I'm going to add pi/2 and then just copy the sin:getRealRange() code", duration=0},
	{code="", comment="../../sinh.lua:sinh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=0},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="../../Constant.lua:function Constant:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/mul.lua:\9\9local I2 = self[i]:getRealRange()", duration=9.9999999999406e-07},
	{code="", comment="../../op/div.lua:function div:getRealRange()", duration=1.000000000001e-06},
	...
	{code="", comment="../../op/sub.lua:\9\9local I2 = self[i]:getRealRange()", duration=1.000000000001e-06},
	{code="", comment="../../op/add.lua:function add:getRealRange()", duration=1.000000000001e-06},
	{code="", comment="../../op/add.lua:\9local I = self[1]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/pow.lua:\9local I = self[1]:getRealRange()", duration=0},
	...
	{code="", comment="../../op/unm.lua:\9local I = self[1]:getRealRange()", duration=9.9999999999406e-07},
	{code="", comment="", duration=0},
	{code="", comment="../../set/RealSubset.lua:-- commonly used versions of the Expression:getRealRange function", duration=1.000000000001e-06},
	...
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_posInc_negIm(x)", duration=0},
	...
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=0},
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_inc(x)", duration=0},
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=0},
