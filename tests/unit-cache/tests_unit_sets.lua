{
	{code="", comment="TODO do unit tests with the RealInterval / RealSubset operators", duration=2.000000000002e-06},
	...
	{code="", comment="", duration=0},
	{code="", comment="realsubset", duration=9.9999999999406e-07},
	{code="", comment="", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="containing constants", duration=1.7000000000003e-05},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="if x's set is an intersection of this set then return nil", duration=0},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="1/x should be disjoint", duration=0},
	{
	...
	{code="", comment="../../atan.lua:atan.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=9.9999999999406e-07},
	...
	{code="", comment="../../cos.lua:function cos:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/mul.lua:\9\9local I2 = self[i]:getRealRange()", duration=0},
	...
	{code="", comment="../../op/add.lua:\9\9local I2 = self[i]:getRealRange()", duration=9.9999999999406e-07},
