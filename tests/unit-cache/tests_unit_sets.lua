{
	...
	{code="", comment="TODO don't use \":contains()\" except for element testing, as in sets-of-sets", duration=9.9999999999406e-07},
	...
	{code="", comment="if x's set is a subset of this set then return true", duration=9.9999999999406e-07},
	...
	{code="", comment="../../Expression.lua:function Expression:getRealRange()", duration=0},
	...
	{code="", comment="../../op/pow.lua:\9local I = self[1]:getRealRange()", duration=2.000000000002e-06},
	{code="", comment="../../op/pow.lua:\9local I2 = self[2]:getRealRange()", duration=1.9999999999951e-06},
	...
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_pmOneInc(x)", duration=9.9999999999406e-07},
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=9.9999999999406e-07},
