{
	...
	{code="", comment="maybe.", duration=9.9999999999753e-07},
	...
	{code="", comment="if x's set is a subset of this set then return true", duration=9.9999999999753e-07},
	...
	{code="", comment="../../acos.lua:function acos:getRealRange()", duration=9.9999999999406e-07},
	{code="", comment="../../acos.lua:\9local Is = self[1]:getRealRange()", duration=0},
	{code="", comment="../../tanh.lua:tanh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=9.9999999999406e-07},
	...
	{code="", comment="../../sqrt.lua:sqrt.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_posInc_negIm", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/pow.lua:\9local I = self[1]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=0},
	{code="", comment="../../set/RealInterval.lua:\9local I = x:getRealRange()", duration=9.9999999999406e-07}
}