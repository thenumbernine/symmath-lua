{
	...
	{code="", comment="TODO don't use \":contains()\" except for element testing, as in sets-of-sets", duration=9.9999999999753e-07},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=0},
	{code="", comment="x is in (-inf, inf).", duration=9.9999999999406e-07},
	...
	{code="", comment="../../cos.lua:\9local Is = self[1]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/sub.lua:function sub:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=1.000000000001e-06},
	{code="", comment="../../set/RealInterval.lua:\9local I = x:getRealRange()", duration=0}
}