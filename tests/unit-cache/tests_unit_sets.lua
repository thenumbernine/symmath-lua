{
	{code="", comment="TODO do unit tests with the RealInterval / RealSubset operators", duration=1.9999999999985e-06},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="containing constants", duration=9.9999999999753e-07},
	{code="", comment="", duration=0},
	{
	...
	{code="", comment="../../asin.lua:asin.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_pmOneInc", duration=0},
	...
	{code="", comment="../../atanh.lua:atanh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_pmOneInc", duration=0},
	...
	{code="", comment="../../Expression.lua:function Expression:getRealRange()", duration=9.9999999999406e-07},
	{code="", comment="../../Variable.lua:function Variable:getRealRange()", duration=0},
	{code="", comment="", duration=0},
	{code="", comment="../../op/mul.lua:function mul:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../op/div.lua:\9local I2 = self[2]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_evenIncreasing(x)", duration=9.9999999999406e-07},
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=1.000000000001e-06},
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_posInc_negIm(x)", duration=9.9999999999406e-07},
