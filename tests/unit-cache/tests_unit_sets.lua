{
	...
	{code="", comment="TODO don't use \":contains()\" except for element testing, as in sets-of-sets", duration=0},
	{code="", comment="instead here use isSubsetOf", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="realsubset", duration=0},
	...
	{code="", comment="containing constants", duration=9.9999999999406e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="containing ranges of expressions", duration=9.9999999999406e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.9999999999999e-05},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="x is in (-inf, inf).", duration=0},
	{code="", comment="is x in (0, inf)?", duration=1.000000000001e-06},
	{code="", comment="maybe.", duration=1.000000000001e-06},
	{code="", comment="not certainly yes (subset).", duration=9.9999999999406e-07},
	{code="", comment="not certainly no (complement intersection / set subtraction is empty).", duration=0},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=0},
	{code="", comment="x^2 should be positive", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="../../sin.lua:\9local Is = self[1]:getRealRange()", duration=0},
	{code="", comment="../../asinh.lua:asinh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=9.9999999999406e-07},
	...
	{code="", comment="../../acosh.lua:\9local Is = x[1]:getRealRange()", duration=1.000000000001e-06},
	...
	{code="", comment="../../tan.lua:\9local Is = self[1]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../cos.lua:\9\9-- here I'm going to add pi/2 and then just copy the sin:getRealRange() code", duration=9.9999999999406e-07},
	{code="", comment="../../sinh.lua:sinh.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_inc", duration=1.000000000001e-06},
	{code="", comment="../../abs.lua:abs.getRealRange = require 'symmath.set.RealSubset'.getRealDomain_evenIncreasing", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	...
	{code="", comment="../../Variable.lua:function Variable:getRealRange()", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	...
	{code="", comment="../../op/pow.lua:\9local I2 = self[2]:getRealRange()", duration=9.9999999999406e-07},
	...
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=1.000000000001e-06},
	{code="", comment="../../set/RealSubset.lua:function RealSubset.getRealDomain_inc(x)", duration=9.9999999999406e-07},
	{code="", comment="../../set/RealSubset.lua:\9local Is = x[1]:getRealRange()", duration=9.9999999999406e-07},
