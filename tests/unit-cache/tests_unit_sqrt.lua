{
	...
	{
		code="local expr = 2*sqrt(2)*sqrt(3) local sexpr = expr() printbr(Verbose(expr), '=', Verbose(sexpr)) simplifyAssertEq(expr,sexpr)",
		comment="",
		duration=0.00428,
	...
	{code="", comment="", duration=9.9999999997324e-07},
	{code="", comment="", duration=1.0000000000288e-06},
	{code="", comment="hmm having constant factor and sqrt/pow simplification problems", duration=0},
	{
	...
	{code="", comment="so I need to merge powers if the power is a fraction *and* the denominator matches", duration=9.9999999997324e-07},
	{code="", comment="", duration=1.0000000000288e-06},
