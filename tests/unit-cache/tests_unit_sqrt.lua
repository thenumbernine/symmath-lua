{
	...
	{code="", comment="", duration=0},
	{code="", comment="", duration=9.9999999991773e-07},
	{code="", comment="simplify() was introducing an unflattened mul where there originally was none", duration=1.0000000000288e-06},
	{code="", comment="TODO NOTICE - if there's just sqrt(2)*sqrt(3) then the sqrts will merge ... so should they merge if that extra 2 is out front?", duration=9.9999999991773e-07},
	{
