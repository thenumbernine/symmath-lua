{
	...
	{code="", comment="simplify() was introducing an unflattened mul where there originally was none", duration=9.9999999997324e-07},
	...
	{code="", comment="", duration=0},
	{code="", comment="", duration=1.0000000000288e-06},
	{code="", comment="these go bad when I don't have mul/Prune/combineMulOfLikePow_mulPowAdd", duration=9.9999999997324e-07},
	{
	...
	{code="", comment="", duration=9.9999999997324e-07},
	{code="", comment="", duration=1.0000000000288e-06},
	{code="", comment="hmm having constant factor and sqrt/pow simplification problems", duration=9.9999999997324e-07},
	{
		code="simplifyAssertEq( sqrt(15) - sqrt(15), 0)",
		comment="works",
		duration=0.00051299999999999,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{
	...
	{code="", comment="so I need to merge powers if the power is a fraction *and* the denominator matches", duration=0},
	{code="", comment="", duration=0},
