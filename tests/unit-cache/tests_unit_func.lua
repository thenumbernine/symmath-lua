{
	...
	{code="", comment="assert(UserFunction.registeredFunctions.f == f)", duration=9.9999999999406e-07},
	{code="", comment="", duration=0},
	{code="", comment="instead, if UserFunction returns Functions, this is what you would see", duration=1.000000000001e-06},
	{code="", comment="and with this the derivative evaluation is obvious", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="total derivative evaluation", duration=0},
	...
	{code="", comment="which means it isn't a Variable", duration=0},
