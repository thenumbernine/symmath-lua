{
	...
	{code="", comment="f = func('f', {x, y}, x*y)", duration=9.9999999999406e-07},
	...
	{code="", comment="df/dx, when simplified, does not go anywhere, because f is dependent on x", duration=1.7000000000003e-05},
