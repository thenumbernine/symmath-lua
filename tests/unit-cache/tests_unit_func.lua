{
	...
	{code="", comment="totalDiff() is total derivative", duration=9.9999999999406e-07},
	{code="", comment="", duration=1.000000000001e-06},
	...
	{code="", comment="though you could diff(y(x)) ...", duration=0},
	...
	{code="", comment="in contrast ∂/∂x \"the def of f\" would be a placeholder (in absense of f's provided definition)", duration=0}
}