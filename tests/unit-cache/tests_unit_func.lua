{
	...
	{code="", comment="TODO what to display...", duration=9.9999999999753e-07},
	{code="", comment="y = x", duration=9.9999999999753e-07},
	{code="", comment="y(x) = x", duration=2.000000000002e-06},
	...
	{code="", comment="because you cannot have Functions as Variables in the arg list", duration=0},
	...
	{code="", comment="df/dx, when simplified, does not go anywhere, because f is dependent on x", duration=1.7999999999997e-05},
