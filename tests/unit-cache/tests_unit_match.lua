{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="functions", duration=9.9999999999753e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=0},
	{code="", comment="doubled-up matches should only work if they match", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="same with mul", duration=2.000000000002e-06},
	{code="", comment="", duration=1.000000000001e-06},
	{
		code="simplifyAssertAllEq({(x * y):match(y * W(1))}, {x})",
		comment="",
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=9.9999999999406e-07},
	{code="", comment="combinations of add and mul", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="for this to work, add.wildcardMatches must call the wildcard-capable objects' own wildcard handlers correctly (and use push/pop match states, instead of assigning to wildcard indexes directly?)", duration=9.9999999999406e-07},
