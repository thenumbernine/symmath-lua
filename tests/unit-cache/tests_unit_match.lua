{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="functions", duration=9.9999999999406e-07},
	...
	{code="", comment="", duration=0},
	{code="", comment="add match to second term", duration=0},
	{
	...
	{code="", comment="otherwise 'dependsOn' will match everything, since the mul of a non-dep and a dep itself is dep on 'x', so it will include non-dep-on-terms", duration=9.9999999998712e-07},
	{
	...
	{code="", comment="TensorRef", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	{
