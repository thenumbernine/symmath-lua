{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="add match to second term", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="", duration=1.2999999999999e-05},
	{
		code="simplifyAssertAllEq({(x * y):match(W(1) + W(2))}, {x * y, zero})",
		comment="",
		duration=0.000854,
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="verify 'atMost' cooperates with non-atMost wildcards", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="either 1 or 2 must be zero, and either 3 or 4 must be zero", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="defaults:", duration=0},
	{
