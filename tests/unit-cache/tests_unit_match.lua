{
	...
	{code="", comment="this too", duration=1.000000000001e-06},
	{
		...
		comment="",
		duration=0.00039600000000001,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="this should match (x+y), 0", duration=2.000000000002e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="for these to work, I have to add the multi-wildcard stuff to the non-wildcard elements, handled in add.wildcardMatches", duration=2.000000000002e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=2.000000000002e-06},
	{code="", comment="how can you take x*y and match only the 'x'?", duration=9.9999999998712e-07},
	{code="", comment="", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="div", duration=9.9999999998712e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=9.9999999998712e-07},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="pow", duration=2.000000000002e-06},
	{code="", comment="", duration=0},
	{
	...
	{code="", comment="", duration=9.9999999998712e-07},
	{code="", comment="etc", duration=1.9999999999881e-06},
	{code="", comment="", duration=1.000000000001e-06},
	{
