{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="hmm, how to account for this?  if the fixed indexes don't match then I still want it to fall back on a plain replace()", duration=1.9999999999881e-06},
	{
	...
	{code="", comment="but in the event of a regular replace, I still want it to not collide sum indexes", duration=9.9999999998712e-07},
	{
	...
	},
	{
		...
		comment="",
		duration=0.00041100000000001,
		simplifyStack={}
	},
	{
		code="print( (c'_b' * a'^a' * a'_a'):replaceIndex(c'_b' * a'^a' * a'_a', 2))",
		comment="",
		duration=0.00054799999999999,
		simplifyStack={}
	}
}