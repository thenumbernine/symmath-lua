{
	...
	{code="", comment="", duration=0},
	{code="", comment="", duration=5.2999999999997e-05},
	{
	...
	{code="", comment="what does this mean? the fixed indexes shouldn't have to match ...", duration=9.9999999999406e-07},
	...
	{code="", comment="same but replace with scalars", duration=0},
	{
