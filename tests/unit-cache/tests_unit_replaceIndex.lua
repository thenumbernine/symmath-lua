{
	...
	{code="", comment="that's when the sum indexes aren't replaced correctly", duration=9.9999999999406e-07},
	{
	...
	},
	{
		...
		comment="",
		duration=0.00078399999999999,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "*:Tidy:apply", "Tidy"}
	},
	{code="", comment="", duration=0},
	{code="", comment="TODO make sure summed indexes aren't matched incorreclty", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="does fixed in the find/repl to map into sums in the expr", duration=0},
	{
	...
	{code="", comment="internal sum indexes do seem to work in replaceIndex, like A^a_a, but externally shared between two tensors don't: A^a * A_a ... why distinguish?", duration=0},
	{
