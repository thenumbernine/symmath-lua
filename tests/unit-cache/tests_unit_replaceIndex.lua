{
	...
	{code="", comment="", duration=9.9999999999822e-06},
	{
	...
	{code="", comment="", duration=0.00012300000000001},
	...
	{code="", comment="", duration=5.000000000005e-06},
	{code="", comment="hmm, how to account for this?  if the fixed indexes don't match then I still want it to fall back on a plain replace()", duration=4.000000000004e-06},
	{
		code="simplifyAssertEq( a'_t':replaceIndex(a'_t', b), b)",
		comment="",
		duration=0.00059999999999999,
		simplifyStack={}
	},
	{
	...
	{code="", comment="but in the event of a regular replace, I still want it to not collide sum indexes", duration=5.000000000005e-06},
	{
	...
	{code="", comment="what does this mean? the fixed indexes shouldn't have to match ...", duration=6.000000000006e-06},
	{code="", comment="if they don't match then assume they are not correlated between the 'find' and 'replace'", duration=4.000000000004e-06},
	{code="", comment="", duration=4.000000000004e-06},
	{
	...
	{code="", comment="", duration=6.000000000006e-06},
	{code="", comment="TODO so it looks like, when the replace expression has sum terms *AND* it is an Expression instead of just a TensorRef", duration=4.000000000004e-06},
	{code="", comment="that's when the sum indexes aren't replaced correctly", duration=4.000000000004e-06},
	{
	...
	{code="", comment="only if extra indexes match.  in this case, extra is 'k'.", duration=3.9999999999485e-06},
	{
	...
	{code="", comment="", duration=4.000000000004e-06},
	{code="", comment="TODO make sure summed indexes aren't matched incorreclty", duration=4.000000000004e-06},
	{
	...
	{code="", comment="same but replace with scalars", duration=1.000000000001e-05},
	{
	...
	{code="", comment="", duration=6.000000000006e-06},
	{code="", comment="does fixed in the find/repl to map into sums in the expr", duration=6.000000000006e-06},
	{
	...
	{code="", comment="", duration=5.0000000000328e-06},
	{code="", comment="why do neither of these work?  because if there are *only* sum-indexes won't match, however if there are extra indexes then it will match.  why do we have this constraint again?", duration=4.9999999999772e-06},
	{code="", comment="internal sum indexes do seem to work in replaceIndex, like A^a_a, but externally shared between two tensors don't: A^a * A_a ... why distinguish?", duration=4.9999999999772e-06},
	{
		code="print( (a'^a' * a'_a'):replaceIndex(a'^a' * a'_a', 2))",
		comment="",
		duration=0.00076399999999999,
		simplifyStack={}
	},
	{
	...
	{code="", comment="", duration=4.000000000004e-06},
	{code="", comment="and what about when find/replace has a partial number of fixed indexes", duration=4.000000000004e-06},
	{
