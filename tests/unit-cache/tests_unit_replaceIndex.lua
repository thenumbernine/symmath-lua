{
	...
	{code="", comment="what does this mean? the fixed indexes shouldn't have to match ...", duration=3.000000000003e-06},
	{code="", comment="if they don't match then assume they are not correlated between the 'find' and 'replace'", duration=3.5000000000007e-05},
	{code="", comment="", duration=1.000000000001e-06},
	{
