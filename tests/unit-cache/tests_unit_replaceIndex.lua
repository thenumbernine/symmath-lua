{
	...
	{code="", comment="if they don't match then assume they are not correlated between the 'find' and 'replace'", duration=9.9999999998712e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
	...
	{code="", comment="same but replace with scalars", duration=1.000000000001e-06},
	{
		...
		duration=0.00043799999999999,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{
		code="simplifyAssertEq( a'^a_b':replaceIndex( a'^a_a', b), a'^a_b')",
		comment="",
		duration=0.00043800000000002,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{
