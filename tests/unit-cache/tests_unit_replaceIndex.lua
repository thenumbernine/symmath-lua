{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="TODO so it looks like, when the replace expression has sum terms *AND* it is an Expression instead of just a TensorRef", duration=9.9999999997324e-07},
	{code="", comment="that's when the sum indexes aren't replaced correctly", duration=0},
	{
