{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="hmm, how to account for this?  if the fixed indexes don't match then I still want it to fall back on a plain replace()", duration=9.9999999998712e-07},
	{
	...
	{code="", comment="same but replace with scalars", duration=9.9999999997324e-07},
	{
		...
		duration=0.00074200000000002,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{
		code="simplifyAssertEq( a'^a_b':replaceIndex( a'^a_a', b), a'^a_b')",
		comment="",
		duration=0.00065600000000002,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{
