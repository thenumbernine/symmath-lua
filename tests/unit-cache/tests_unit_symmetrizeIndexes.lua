{
	...
	{code="", comment="or is this meant to dictate values anyhow anywhere?  i.e. a_i,j == a_j,i", duration=9.9999999999406e-07},
	...
	{code="", comment="1) swap variance with symbol.", duration=0},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="maintain raise/lower", duration=9.9999999999961e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="same if the comma is raised? a_ij==a_ji <=> a_i^j,k==a^j_i^,k ?", duration=9.9999999999406e-07},
	...
	{code="", comment="= (g^im a_m)_,np g^pk g^nj + (g^im a_m)_,n g^nj_,p g^pk", duration=9.9999999999406e-07},
