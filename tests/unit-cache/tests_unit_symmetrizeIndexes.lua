{
	...
	{code="", comment="or is this meant to dictate symmetries of non-derivative tensor values (but not derivatives)?  i.e. g_ji,lk = g_ij,kl", duration=0},
	...
	{code="", comment="so use this for symmetries of derivatives and non-derivatives", duration=9.9999999999406e-07},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="", duration=1.6000000000002e-05},
	{
	...
	{code="", comment="= (g^im_,n a_m + g^im a_m,n)_,p g^pk g^nj + (g^im_,n a_m + g^im a_m,n) g^nj_,p g^pk", duration=2.000000000002e-06},
	...
	{code="", comment="but if they are upper then cause an error", duration=0},
	{
	...
	{code="", comment="but also sort all indexes in all multiplied expressions which use 'k' or 'l'", duration=0},
	...
	{code="", comment="g^kl (d_kjl + d_jkl - d_kjl)", duration=0},
