{
	...
	{code="", comment="and a^i_j,k = (g^im a_mj)_,k = g^im_,k a_mj + g^im a_mj,k = g^im_,k a_jm + g^im a_jm,k = (g^im a_jm)_,k = a_j^i_,k", duration=9.9999999999406e-07},
	{code="", comment="so even symmetries with non-matching variance that are wrapped in derivatives can be symmetrized", duration=0},
	{
	...
	{code="", comment="= g^im_,np g^pk g^nj a_m + g^im_,n a_m,p g^pk g^nj + g^im_,p a_m,n g^pk g^nj + g^im_,n a_m g^nj_,p g^pk + g^im a_m,n g^nj_,p g^pk + a_m,np g^im g^pk g^nj", duration=2.000000000002e-06},
	{code="", comment="so it doesn't look like these match", duration=2.9999999999961e-06},
	...
	{code="", comment="another thing symmetrizing can do ...", duration=1.7999999999997e-05},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="same with all-lower", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="", duration=1.799999999999e-05},
	...
	{code="", comment="", duration=1.9000000000005e-05},
	{
