{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="do symmetrize two commas", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="= g^im_,np g^pk g^nj a_m + g^im_,n a_m,p g^pk g^nj + g^im_,p a_m,n g^pk g^nj + g^im_,n a_m g^nj_,p g^pk + g^im a_m,n g^nj_,p g^pk + a_m,np g^im g^pk g^nj", duration=9.9999999998712e-07},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="TODO test for also sort any multiplied tensors?", duration=1.8000000000004e-05},
	...
	{code="", comment="g^kl d_jkl", duration=9.9999999998712e-07},
	{
	...
	{code="", comment="assertError(function() (g'^kl' * (d'_kl,j' + d'_jl,k' - d'_lj,k')):symmetrizeIndexes(g, {1,2}):symmetrizeIndexes(d, {2,3})() end)", duration=9.9999999997324e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
