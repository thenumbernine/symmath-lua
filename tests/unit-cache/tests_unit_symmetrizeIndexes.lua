{
	{code="", comment="fundamentally, is this a function to simplify symmetries that are obvious? such as derivative symmetries, i.e. a_,ji == a_,ij", duration=1.000000000001e-06},
	...
	{code="", comment="I'm leaning towards #1 and #2 but not #3", duration=9.9999999999406e-07},
	{code="", comment="so use this for symmetries of derivatives and non-derivatives", duration=1.000000000001e-06},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="SO THE TAKE-AWAY ...", duration=0},
	...
	{code="", comment="2.5) if all indexes have commas then error if any are upper (unless all are covariant derivatives)", duration=0},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="do allow with override", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="and a^i_j,k = (g^im a_mj)_,k = g^im_,k a_mj + g^im a_mj,k = g^im_,k a_jm + g^im a_jm,k = (g^im a_jm)_,k = a_j^i_,k", duration=0},
	{code="", comment="so even symmetries with non-matching variance that are wrapped in derivatives can be symmetrized", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="= ((g^im a_m)_,np g^nj + (g^im a_m)_,n g^nj_,p) g^pk", duration=1.000000000001e-06},
	{code="", comment="= (g^im a_m)_,np g^pk g^nj + (g^im a_m)_,n g^nj_,p g^pk", duration=1.000000000001e-06},
	{code="", comment="= (g^im_,n a_m + g^im a_m,n)_,p g^pk g^nj + (g^im_,n a_m + g^im a_m,n) g^nj_,p g^pk", duration=1.000000000001e-06},
	{code="", comment="= g^im_,np g^pk g^nj a_m + g^im_,n a_m,p g^pk g^nj + g^im_,p a_m,n g^pk g^nj + g^im_,n a_m g^nj_,p g^pk + g^im a_m,n g^nj_,p g^pk + a_m,np g^im g^pk g^nj", duration=0},
	...
	{code="", comment="= a_m g^im_,np g^pj g^nk + g^im_,n a_m,p g^pj g^nk + g^im_,p a_m,n g^pj g^nk + g^im a_m,np g^pj g^nk + g^im_,n a_m g^nk_,p g^pj + g^im a_m,n g^nk_,p g^pj", duration=9.9999999999406e-07},
	{code="", comment="= a^i,kj", duration=9.9999999999406e-07},
	...
	{code="", comment="but if they are upper then cause an error", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="unless explicitly overridden", duration=9.9999999999406e-07},
	{
	...
	{code="", comment="so this would become", duration=0},
	{code="", comment="g^kl (d_klj + d_jkl - d_kjl)", duration=1.000000000001e-06},
	{code="", comment="then another symmetrize d {2,3} gives us", duration=1.000000000001e-06},
	{code="", comment="g^kl (d_kjl + d_jkl - d_kjl)", duration=9.9999999998712e-07},
	{code="", comment="g^kl d_jkl", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="same with mixed upper/lower", duration=0},
	{
	...
	{code="", comment="assertError(function() (g'^kl' * (d'_kl,j' + d'_jl,k' - d'_lj,k')):symmetrizeIndexes(g, {1,2}) end)", duration=0},
	...
	{code="", comment="assertError(function() (g'^kl' * (d'_kl,j' + d'_jl,k' - d'_lj,k')):symmetrizeIndexes(g, {1,2}):symmetrizeIndexes(d, {2,3})() end)", duration=0},
	{code="", comment="", duration=1.000000000001e-06},
	{
