{
	{code="", comment="fundamentally, is this a function to simplify symmetries that are obvious? such as derivative symmetries, i.e. a_,ji == a_,ij", duration=1.9999999999951e-06},
	...
	{code="", comment="or is this meant to dictate values anyhow anywhere?  i.e. a_i,j == a_j,i", duration=0},
	{code="", comment="I'm leaning towards #1 and #2 but not #3", duration=1.000000000001e-06},
	{code="", comment="so use this for symmetries of derivatives and non-derivatives", duration=0},
	...
	{code="", comment="2) assert the derivative type of the index match, error if they don't.", duration=0},
	...
	{code="", comment="TODO in the case of 3 this isn't used so often", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="maintain raise/lower", duration=1.000000000001e-06},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="do symmetrize two commas", duration=0},
	{
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="if a_ij = a_ji", duration=0},
	{code="", comment="then a^i_j = g^ik a_kj = g^ik a_jk = a_j^i", duration=0},
	...
	{code="", comment="how about if multiple commas are upper?  <=> a^i,jk == a^i,kj ?", duration=0},
	...
	{code="", comment="= a_m g^im_,np g^pj g^nk + g^im_,n a_m,p g^pj g^nk + g^im_,p a_m,n g^pj g^nk + g^im a_m,np g^pj g^nk + g^im_,n a_m g^nk_,p g^pj + g^im a_m,n g^nk_,p g^pj", duration=0},
	...
	{code="", comment="so commas can only be symmetrized if they are all lowered", duration=0},
	{
