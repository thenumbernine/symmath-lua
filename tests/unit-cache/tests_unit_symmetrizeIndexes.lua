{
	...
	{code="", comment="TODO in the case of 3 this isn't used so often", duration=9.9999999999753e-07},
	{
	...
	{code="", comment="a^i,jk = (g^im a_m)^,jk = ((g^im a_m)_,n g^nj)_,p g^pk", duration=9.9999999999406e-07},
	...
	{code="", comment="unless explicitly overridden", duration=0},
	{
	...
	{code="", comment="assertError(function() (g'^kl' * (d'_kl,j' + d'_jl,k' - d'_lj,k')):symmetrizeIndexes(g, {1,2}) end)", duration=9.9999999998712e-07},
