{
	...
	{code="", comment="or is this meant to dictate symmetries of non-derivative tensor values (but not derivatives)?  i.e. g_ji,lk = g_ij,kl", duration=9.9999999999753e-07},
	...
	{code="", comment="1) swap variance with symbol.", duration=9.9999999999753e-07},
	...
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="don't symmetrize a comma and a non-comma (should I restrict this?)", duration=0},
	{
	...
	{code="", comment="do symmetrize two commas", duration=1.9999999999951e-06},
	{
	...
	},
	{
		...
		comment="",
		duration=0.00097299999999999,
		simplifyStack={"Init", "Prune", "Expand", "Prune", "Factor", "Prune", "Tidy"}
	},
	{code="", comment="", duration=1.000000000001e-06},
	{code="", comment="same if the comma is raised? a_ij==a_ji <=> a_i^j,k==a^j_i^,k ?", duration=0},
	...
	{code="", comment="so it doesn't look like these match", duration=9.9999999999406e-07},
	...
	{code="", comment="= a^i,kj", duration=0},
	{code="", comment="this looks like a job for my CAS ... but it isn't looking like upper commas can be assumed to be symmetric", duration=9.9999999999406e-07},
	...
	{code="", comment="but if they are upper then cause an error", duration=1.8000000000004e-05},
	{
	...
	{code="", comment="g^kl (d_kjl + d_jkl - d_kjl)", duration=1.7000000000003e-05},
	...
	{code="", comment="", duration=0},
	{code="", comment="how about with commas?  don't forget, you can't exchange comma positions, even if you override errors, because commas cannot precede non-comma indexes.", duration=9.9999999998712e-07},
	...
	{code="", comment="assertError(function() (g'^kl' * (d'_kl,j' + d'_jl,k' - d'_lj,k')):symmetrizeIndexes(g, {1,2}):symmetrizeIndexes(d, {2,3})() end)", duration=9.9999999998712e-07},
	{code="", comment="", duration=1.000000000001e-06},
	{
